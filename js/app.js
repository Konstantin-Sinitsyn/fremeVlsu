(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        const textareaHeight = document.querySelector(".adaptive-height");
        if (textareaHeight) textareaHeight.addEventListener("input", (event => {
            textareaHeight.style.cssText = "height:auto; padding:0";
            textareaHeight.style.cssText = "height:" + el.scrollHeight + "px";
        }));
        function map(n) {
            ymaps.ready(init);
            function init() {
